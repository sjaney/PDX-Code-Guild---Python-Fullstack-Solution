...
while True: 
    ...
    user = input('Choose the following: rock, paper, scissors, spock, lizard, or "done" to quit: ').lower()

    computer = ['rock', 'paper', 'scissors', 'spock', 'lizard']
    random_answer = random.choice(computer)
    valid_choices = 'rock', 'paper', 'scissors', 'done', 'spock', 'lizard'
    ...
    elif user == 'spock' and random_answer == 'lizard':
        message = f"Your {user} lost to computer's {random_answer}"

    elif user == 'spock' and random_answer == 'paper':
        message = f"Your {user} lost to computer's {random_answer}"

    elif user == 'spock' and random_answer == 'rock':
        message = f"Your {user} beats computer's {random_answer}"

    elif user == 'spock' and random_answer == 'scissors':
        message = f"Your {user} beats computer's {random_answer}"

    elif user == 'lizard' and random_answer == 'paper':
        message = f"Your {user} beats computer's {random_answer}"
    
    elif user == 'lizard' and random_answer == 'rock':
        message = f"Your {user} lost to computer's {random_answer}"

    elif user == 'lizard' and random_answer == 'scissors':
        message = f"Your {user} lost to computer's {random_answer}"
